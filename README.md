...
└── utils/
    ...
    └── RSA.py
```
An empty `server_neighbourhood.json` file is included in this repository. **This file is required for the server to start**. Please fill it out with the servers respecive url and public key. An example looks like this:
```json
{
    "servers": [
        {
